...
\begin{tikzpicture}[nodes in empty cells,
      ...
      \draw[<-] ([yshift=-2mm, xshift=1mm]vector-2-2.south) -- ++(0,-0.5) node[below] {$k$};
      \draw[<-] ([yshift=-2mm, xshift=-1mm]vector-2-2.south) -- ++(0,-0.5) node[below] {$i$};
      ...
      \node(comparison)[below=12mm of vector, xshift=12mm] {$nums1[k] = 2$ };
