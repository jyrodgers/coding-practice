...
\begin{tikzpicture}[nodes in empty cells,
      ...
      \draw[<-] ([yshift=-2mm, xshift=1mm]vector-2-1.south) -- ++(0,-0.5) node[below] {$k$};
      \draw[<-] ([yshift=-2mm, xshift=-1mm]vector-2-1.south) -- ++(0,-0.5) node[below] {$i$};
      ...
      \draw[<-] ([yshift=-2mm, xshift=-6mm]vector2-2-1.south) -- ++(0,-0.5) node[below] {$j$};

      % Show comparison result
      \node(comparison)[below=12mm of vector, xshift=12mm] {$nums1[k] = 1$ };
